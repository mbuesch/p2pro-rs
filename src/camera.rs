...
fn decode_frame(buf: &[u8], fmt: &Format, lut: &[[u8; 4]]) -> Option<ThermalFrame> {
    ...
    for y in 0..half_height {
        ...
        for x in 0..width {
            ...
            // Same conversion as p2pro.py: `raw/64 - 273.2` (Celsius).
            temps.push(raw as f32 / 64.0 - 273.2);
        }
    }

    let rendered = render::build_frame(WIDTH, HEIGHT, &temps, lut);
    Some(ThermalFrame {
